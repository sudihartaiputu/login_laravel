...
<head>
    ...
    <link rel="stylesheet" href="{{asset('assets/welcome/css/open-iconic-bootstrap.min.css')}}">
    ...
    <link rel="stylesheet" href="{{asset('assets/welcome/css/aos.css')}}">
    <link rel="stylesheet" href="{{asset('assets/welcome/css/ionicons.min.css')}}">
    <link rel="stylesheet" href="{{asset('assets/welcome/css/bootstrap-datepicker.css')}}">
    <link rel="stylesheet" href="{{asset('assets/welcome/css/jquery.timepicker.css')}}">
    <link rel="stylesheet" href="{{asset('assets/welcome/css/flaticon.css')}}">
    <link rel="stylesheet" href="{{asset('assets/welcome/css/icomoon.css')}}">
    <link rel="stylesheet" href="{{asset('assets/welcome/css/mystyle.css')}}">
</head>

<body>
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
        <div class="container">
            <a class="navbar-brand" href="{{route('home')}}"><span>SMANEV</span></a>
