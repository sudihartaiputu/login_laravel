...
@section('judul', 'Materi Pembelajaran')
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="text-align:center">
                                        <form action="{{route('gurumateri.destroy', $hasil->id)}}" method="POST">
                                            @csrf
                                            @method('delete')
                                            <a class="fas fa-edit btn btn-primary btn-sm" href="{{route ('gurumateri.edit', $hasil->id)}}"></a>
